    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Belajar santai berkualitas bersama <a href="https://sanbercode.com/" target="_blank"
              class="pe-1 text-primary text-decoration-underline">sanbercode.com</a> </p>
        </div>
      </div>
    </div>
  </div>
